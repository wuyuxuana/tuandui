...
<body>
    <div class="head">
            ...
            <h3 class="head_text fr">新型光器件与光交换团队管理系统</h3>
    </div>
    ...
    <div class="content clearfix">
        ...
        <div class="menu">
            <div class="cont">
                ...
                <ul class="mList">
                    <li>
                        <h3><span onclick="show('menu1','change1')" id="change1">+</span>信息管理</h3>
                        <dl id="menu1" style="display:none;">
                        	<dd><a href="addMes.php" target="mainFrame">信息发布</a></dd>
                            <dd><a href="listMes.php" target="mainFrame">信息列表</a></dd>
                        </dl>
                    </li>
                    <li>
                        <h3><span onclick="show('menu2','change2')" id="change2">+</span>板块管理</h3>
                        <dl id="menu2" style="display:none;">
                        	<dd><a href="addNav.php" target="mainFrame">添加板块</a></dd>
                            <dd><a href="listNav.php" target="mainFrame">板块列表</a></dd>
                        </dl>
                    </li>
                    <li>
