...
<div class="content comWidth">
    ...
    <div class="bar">
        <div id="sidebar" class="fl">
            ...
            <div class="item">
                <a href="main.php?list=<?php echo $row['nId'];?>&cid=<?php echo $row['list'];?>"><?php echo $row['lName']?><?php active($cid);?></a>
            </div>
            <?php endforeach;?>
        </div>
...
<script>
    function click()
    {
        var menu=document.getElementById("sidebar").getElementsByClassName("item");
        for(var i=0;i<menu.length;i++)
        {
            if(menu[i].className=="item")
            {
