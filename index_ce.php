...
<body>
<div class="header">
    <div class="comWidth container">
        <a href="./" id="logo" title="电子科技大学">
            <img src="images/logos/logo.png" alt="电子科大学"/><span>-光交换小组</span>
        </a>
        <div class="searcher fr">
            ...
            <form action="">
                ...
                <input class="searcher_02 " type="button" value="搜索"/>
            </form>
        </div>
    </div>
    <div class="nav comWidth" id="nav">
        <ul>
            <li class="nav_tags"><a href="index.html">首页</a></li>
            <li class="nav_tags">
